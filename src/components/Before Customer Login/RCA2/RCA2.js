    ...
    <div>
      ...
      <div className="rca2" onClick={isOpend ? toggleDropdown : null}>
        <div className="rca2firstHalf">
          ...
          <div className="rca2subtitle1">Your Business Details</div>
          <div>
            <form action="">
              <input
                required
              ...
              />{" "}
              <label className="input5-label">Business Registered Name*</label>{" "}
              <span className=" rca2inputError input5Error">{input5Error}</span>
              <input
                required
              ...
              />{" "}
              <label className="input6-label">Business Trade Name*</label>{" "}
              <span className=" rca2inputError input6Error">{input6Error}</span>
              ...
              <div className="dropdown">
                <div className="dropdown-header" onClick={toggleDropdown}>
                  {selectedItem ? (
                    ...
                    <span style={{ color: "#999" }}>Business Type*</span>
                  )}
                  <i
                    className={`fa fa-chevron-right icon ${isOpend && "open"}`}
                  ></i>
                  <img
                    src={require("../../../Img/adminDropdown.png")}
                    className={`commondropdown ${
                      isOpend && "commondropdownrotate"
                    }`}
                  />
                </div>
            ...
            /> <label className="input7-label" >Business Type*</label> */}
              <div style={{ display: "flex", margin: "2.7vh 0px 0px 6.51vw" }}>
                ...
                <div className="rca2subtitle3">Enter Address manually</div>
                <Radio
                  type="radio"
                  name="radio"
              ...
              />{" "}
              <label className="input8-label">Start typing address</label>{" "}
              ...
              />{" "}
              {checked && (
                <label className="input9-label">Address line 1*</label>
              )}{" "}
              ...
              />{" "}
              {checked && (
                <label className="input10-label">Address line 2*</label>
              )}{" "}
              <span className=" rca2inputError input10Error">
                {input10Error}
              </span>
              <input
                required
                ...
                disabled={checked === false ? true : false}
              />{" "}
              {checked && <label className="input11-label">City/Town*</label>}{" "}
              <span className=" rca2inputError input11Error">
                {input11Error}
              </span>
              <input
                required
                ...
                disabled={checked === false ? true : false}
              />{" "}
              {checked && <label className="input12-label">PostCode*</label>}{" "}
              <span className=" rca2inputError input12Error">
                {input12Error}
              </span>
              <img
